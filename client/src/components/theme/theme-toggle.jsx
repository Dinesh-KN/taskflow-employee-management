...
export function ModeToggle() {
  ...
  return (
    ...
    >
      <Sun className="size-4 scale-100 rotate-0 transition-all duration-300 motion-reduce:transition-none dark:scale-0 dark:-rotate-90" />
      <Moon className="absolute inset-0 m-auto size-4 scale-0 rotate-90 transition-all duration-300 motion-reduce:transition-none dark:scale-100 dark:rotate-0" />
    </Button>
  );
}
